...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/status-0.3.6--beta-f6bf6f" alt="0.3.6 beta">
...
> [!IMPORTANT]
> `0.3.6-beta` contains the complete core feature set, but it remains a functional beta rather than a publicly validated stable release. Real-device, zero-speaker-leakage testing is still a release gate; a successful build does not prove that every device is safe.
